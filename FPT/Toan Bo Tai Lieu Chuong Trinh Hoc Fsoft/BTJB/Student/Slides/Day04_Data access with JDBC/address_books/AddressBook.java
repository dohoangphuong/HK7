...
public class AddressBook extends JFrame {
	...
	private class NewAction extends AbstractAction {
		...
		public NewAction() {
			putValue(NAME, "New");
			putValue(SMALL_ICON,
					new ImageIcon(getClass().getResource("images/New24.png")));
	...
	private class SaveAction extends AbstractAction {
		...
		public SaveAction() {
			putValue(NAME, "Save");
			putValue(SMALL_ICON,
					new ImageIcon(getClass().getResource("images/Save24.png")));
		...
		public void actionPerformed(ActionEvent e) {
			...
			AddressBookEntryFrame currentFrame = (AddressBookEntryFrame) desktop
					.getSelectedFrame();
			...
			try {
				...
				JOptionPane.showMessageDialog(desktop, operation
						+ " successful");
			} // end try
	...
	private class DeleteAction extends AbstractAction {
		...
		public DeleteAction() {
			...
			putValue(
					SMALL_ICON,
					new ImageIcon(getClass().getResource("images/Delete24.png")));
	...
	private class SearchAction extends AbstractAction {
		...
		public SearchAction() {
			...
			putValue(SMALL_ICON,
					new ImageIcon(getClass().getResource("images/Find24.png")));
