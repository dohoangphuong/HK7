...
public:
	...
	// This function is used to display Withdraw screen
	void DisplayWithdraw();
	// This function is used to display CheckPIN screen
	void DisplayCheckPIN();
	// This function is used to display ViewBalance screen
	void DisplayViewBalance();
};
